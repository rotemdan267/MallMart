...
{
    public partial class NewCategoryUC : UserControl
    {
        public Category Category { get; set; }
        public NewCategoryUC()
        {
            Category = new Category();
            InitializeComponent();
        }

        private void NewCategoryUC_Load(object sender, EventArgs e)
        {
            this.Dock = DockStyle.Fill;
            MyResize();
        }

        private void NewCategoryUC_Resize(object sender, EventArgs e)
        {
            MyResize();
        }
        ...
        void MyResize()
        {
            ...
            saveCtgryBtn.Location = new Point((this.Size.Width / 2) - (saveCtgryBtn.Size.Width / 2)
                , this.Size.Height * 25 / 36);
